...
console.log(Object.keys(globalThis));
console.log(globalThis.parent);
console.log(globalThis.parent.call_from_js);
console.log(globalThis.parent.add_child);
globalThis.parent.call_from_js.call();
globalThis.parent.add_child.call(s);